-- Repair environments whose migration ledger contains 0077 but whose
-- cross-device relations were removed or never materialized. This must sort
-- before 0078, which adds mandatory company isolation to these records.
